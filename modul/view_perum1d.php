...
#t6.active	{ background-position:-875px 0 !important; }
   ...
   <div id="scroll">
	...
	<div id="intro" class="tool" style=" -moz-background-clip: border; -moz-background-origin: padding; -moz-background-inline-policy: continuous;">
     ...
     <br/> <br/>
    <p align="left" style="font-size:16px;" onClick="ambildata18('awal')"><img src="icon/sd.jpg" id="tombol_dp" value="dp" align="left" style="width:40px; height:30px; padding-right:5px;" /> SD/MI</p>
	<br/>
	<p align="left" style="font-size:16px;" onClick="ambildata19('awal')"><img src="icon/smp.jpg" id="tombol_dp" value="dp" align="left" style="width:40px; height:30px; padding-right:5px;" /> SMP/MTS</p>
	<br/>
	<p align="left" style="font-size:16px;"  onClick="ambildata20('awal')"><img src="icon/sma.jpg" id="tombol_dp" value="dp" align="left" style="width:40px; height:30px; padding-right:5px;" /> SMA/SMK/MA</p>
	<br/>
	<p align="left" style="font-size:16px;" onClick="ambildata31('awal')"><img src="icon/kuliah.jpg" id="tombol_dp" value="dp" align="left" style="width:40px; height:30px; padding-right:5px;"/> Universitas</p>
	<br/>
	<p align="left" style="font-size:16px;" onClick="ambildata22('awal')"><img src="icon/pesantren.jpg" id="tombol_dp" value="dp" align="left" style="width:40px; height:30px; padding-right:5px;" /> Pondok Pesantren</p>
	<br/>
	<p align="left" style="font-size:16px;" onClick="ambildata23('awal')"><img src="icon/anak.jpg" id="tombol_dp" value="dp" align="left" style="width:40px; height:30px; padding-right:5px;" /> Panti Asuhan</p>
	<br/>
	<p align="left" style="font-size:16px;" onClick="ambildata21('awal')"><img src="icon/bimbel.jpg" id="tombol_dp" value="dp" align="left" style="width:40px; height:30px; padding-right:5px;" /> Les / Bimbel</p>
	<br/>
	<p align="left" style="font-size:16px;" onClick="ambildata24('awal')"><img src="icon/buku.png" id="tombol_dp" value="dp" align="left" style="width:40px; height:30px; padding-right:5px;" /> Toko Buku</p>
<table width="100%" border="0" cellspacing="0" cellpadding="5">
      <tr><td width="78%" align="right"><form method="post" action="" > <input type="submit" value="Bersih"  style="background:#000000; color:#00FF00;"/> </form></td>
        <td><p align="right"><a href="view_perum1.php?id=<?php echo $id;?>"><em>back</em></a></p></td>
      </tr>
    </table>
