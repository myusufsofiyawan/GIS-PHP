...
function peta_awal(){
    var BL = new google.maps.LatLng(-5.4285795, 105.2674755);
    var petaoption = {
        zoom: 12,
        center: BL,
   ...
   <div id="scroll">
	...
	<div id="intro" class="tool" style=" -moz-background-clip: border; -moz-background-origin: padding; -moz-background-inline-policy: continuous;">
		...
		<div class="demos" style="position: relative; z-index: 1;">
			...
			<h2 align="center"><?php echo "Bandar Lampung";?></h2>

     <br/> <br/><br/><br/>
    <a href="#"> <p align="left" style="font-size:16px;"><img src="icon/transportasi.png" align="left" style="width:40px; height:30px; padding-right:5px;" /> Transportasi</p> </a>
	<br/><br/>
	<a href="#"> <p align="left" style="font-size:16px;"><img src="icon/layanan_umum.png" id="tombol_dp" value="dp" align="left" style="width:40px; height:30px; padding-right:5px;"/> Layanan Umum</p></a>
	<br/><br/>
    <a href="#"> <p align="left" style="font-size:16px;"><img src="icon/pasar.png" id="tombol_dp" value="dp" align="left" style="width:40px; height:30px; padding-right:5px;"/> Pasar</p></a>
	<br/><br/>
	<a href="#"> <p align="left" style="font-size:16px;"><img src="icon/pendidikan.jpg" id="tombol_dp" value="dp" align="left" style="width:40px; height:30px; padding-right:5px;" /> Pendidikan</p></a>
	<br/><br/>
	<a href="#"> <p align="left" style="font-size:16px;"><img src="icon/wisata.png" id="tombol_dp" value="dp" align="left" style="width:40px; height:30px; padding-right:5px;" /> Wisata</p></a>
	<br/><br/>
    <a href="#"> <p align="left" style="font-size:16px;"><img src="icon/rumah2.jpg" id="tombol_dp" value="dp" align="left" style="width:40px; height:30px; padding-right:5px;" /> Perumahan Penduduk</p></a>
	<br/><br/>
