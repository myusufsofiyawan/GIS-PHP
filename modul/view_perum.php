...
function peta_awal(){
    var BL = new google.maps.LatLng(-5.391975475062449, 105.20258903503418);
    var petaoption = {
        zoom: 15,
        center: BL,
...
#t6.active	{ background-position:-875px 0 !important; }
   ...
   <div id="scroll">
	...
	<div id="intro" class="tool" style=" -moz-background-clip: border; -moz-background-origin: padding; -moz-background-inline-policy: continuous;">
     ...
     <br/> <br/><br/><br/>
    <a href="we.php" target="_self"><p align="left" style="font-size:16px;"><img src="icon/transportasi.png" id="tombol_dp" value="dp" align="left" style="width:40px; height:30px; padding-right:5px;" onClick="ambildatadp('awal')"/> Transportasi</p> </a>
	<br/>
	<p align="left" style="font-size:16px;"><img src="icon/layanan_umum.png" id="tombol_dp" value="dp" align="left" style="width:40px; height:30px; padding-right:5px;" onClick="ambildatadp('awal')"/> Layanan Umum</p>
	<br/>
    <p align="left" style="font-size:16px;"><img src="icon/layanan_umum.png" id="tombol_dp" value="dp" align="left" style="width:40px; height:30px; padding-right:5px;" onClick="ambildatadp('awal')"/> Pasar</p>
	<br/>
    <p align="left" style="font-size:16px;"><img src="icon/layanan_umum.png" id="tombol_dp" value="dp" align="left" style="width:40px; height:30px; padding-right:5px;" onClick="ambildatadp('awal')"/> Pendidikan</p>
	<br/>
    <p align="left" style="font-size:16px;"><img src="icon/layanan_umum.png" id="tombol_dp" value="dp" align="left" style="width:40px; height:30px; padding-right:5px;" onClick="ambildatadp('awal')"/> Wisata</p>
	<br/>
    <p align="left" style="font-size:16px;"><img src="icon/layanan_umum.png" id="tombol_dp" value="dp" align="left" style="width:40px; height:30px; padding-right:5px;" onClick="ambildatadp('awal')"/> Pemukiman Penduduk</p>
	<br/>
...
$("#t0").click(function() {
	...
	$("#scroll").scrollable().begin();
          ...
          <blockquote>
            <p>Silakan Klik Menu Home Di Samping Ini Untuk Kembali ke Halaman Utama : <a href="../index.php"> Home</a> </p>
            <p>
