...
#t6.active	{ background-position:-875px 0 !important; }
   ...
   <div id="scroll">
	...
	<div id="intro" class="tool" style=" -moz-background-clip: border; -moz-background-origin: padding; -moz-background-inline-policy: continuous;">
     ...
     <br/> <br/>
    <p align="left" style="font-size:16px;" onClick="ambildata26('awal')" ><img src="icon/wisata.jpg" id="tombol_dp" value="dp" align="left" style="width:40px; height:30px; padding-right:5px;" /> Wisata Hiburan </p>
	<br/><br/>
	<p align="left" style="font-size:16px;" onClick="ambildata28('awal')"><img src="icon/belanja.png" id="tombol_dp" value="dp" align="left" style="width:40px; height:30px; padding-right:5px;" /> Belanja Oleh - Oleh </p>
	<br/><br/>
	<p align="left" style="font-size:16px;" onClick="ambildata29('awal')"><img src="icon/hotel.jpg" id="tombol_dp" value="dp" align="left" style="width:40px; height:40px; padding-right:5px;" /> Hotel</p>
	<br/><br/>
	<p align="left" style="font-size:16px;" onClick="ambildata27('awal')"><img src="icon/restoran.png" id="tombol_dp" value="dp" align="left" style="width:40px; height:30px; padding-right:5px;" /> Kuliner</p>
