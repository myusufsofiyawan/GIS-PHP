...
#t6.active	{ background-position:-875px 0 !important; }
   ...
   <div id="scroll">
    ...
    <p align="left" style="font-size:16px;" onClick="ambildatadp('awal')"><img src="icon/spbu.jpg" id="tombol_dp" value="dp" align="left" style="width:40px; height:30px; padding-right:5px;" /> SPBU</p>
	<br/>
	<p align="left" style="font-size:16px;" onClick="ambildata01('awal')"><img src="icon/haltebus.jpg" id="tombol_dp" value="dp" align="left" style="width:40px; height:30px; padding-right:5px;" /> Halte</p>
	<br/>
	<p align="left" style="font-size:16px;" onClick="ambildata09('awal')"><img src="icon/dp.png" id="tombol_dp" value="dp" align="left" style="width:40px; height:30px; padding-right:5px;" /> Kantor Publik</p>
	<br/>
	<p align="left" style="font-size:16px;" onClick="ambildata11('awal')"><img src="icon/kecamatan.png" id="tombol_dp" value="dp" align="left" style="width:40px; height:30px; padding-right:5px;" /> Kantor Kecamatan</p>
	<br/>
	<p align="left" style="font-size:16px;" onClick="ambildata32('awal')"><img src="icon/home-back.png" id="tombol_dp" value="dp" align="left" style="width:40px; height:30px; padding-right:5px;" /> Kantor Kelurahan</p>
	<br/>
	<p align="left" style="font-size:16px;" onClick="ambildata33('awal')"><img src="icon/supermarket.jpg" id="tombol_dp" value="dp" align="left" style="width:40px; height:30px; padding-right:5px;" /> Kantor Layanan Publik</p>
	<br/>
	<p align="left" style="font-size:16px;" onClick="ambildata35('awal')"><img src="icon/rk-back.png" id="tombol_dp" value="dp" align="left" style="width:40px; height:30px; padding-right:5px;" /> Surat Kabar </p>
	<br/>
	<p align="left" style="font-size:16px;" onClick="ambildata36('awal')"><img src="icon/pln.jpg" id="tombol_dp" value="dp" align="left" style="width:40px; height:30px; padding-right:5px;" /> Kantor PLN</p>
	<br/>
	<p align="left" style="font-size:16px;" onClick="ambildata37('awal')"><img src="icon/layanan_umum.png" id="tombol_dp" value="dp" align="left" style="width:40px; height:30px; padding-right:5px;" /> PKOR </p>
	<br/> 
	<a href="view_perum1b.php?id=<?php echo $id;?>"><p align="right" style="font-size:12px"> <em> </em></p></a>
	<table width="100%" border="0" cellspacing="0" cellpadding="5">
      <tr><td width="78%" align="right"><form method="post" action="" > <input type="submit" value="Bersih"  style="background:#000000; color:#00FF00;"/> </form></td>
        <td><a href="view_perum1b.php?id=<?php echo $id;?>">
	<p align="right" style="font-size:12px"><em>back</em> </p>
	</a></td>
      </tr>
    </table>
