...
class mysrc extends drasticsrcmysql {
	protected function select(){
		$res = mysql_query("SELECT * FROM $this->table WHERE daerah='Bandar Lampung'" . $this->orderbystr, $this->conn) or die(mysql_error());
		return ($res);
	}
}
...
<title>Teknokrat Team - Bandar Lampung GIS</title>
</head><body>
...
<div>
<div id="map1" style="position: absolute; width: 500px; height: 410px; left: 0; top: 0;" title="Peta Calon Pelanggan Telkom Kota Bogor">Peta Informasi Kota Bandar Lampung</div>
<div id="grid1" style="position: absolute; left: 515px; top: 0;"></div>
<div id="cloud1" style="position: absolute; left: 0; top: 420px"></div>
<div id="hehe" style="position: relative; left: 300; top: 650px">Copyright &copy; 2014 by GIS Teknokrat Team, Google Technology</div>
</div>
