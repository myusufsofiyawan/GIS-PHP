...
#t6.active	{ background-position:-875px 0 !important; }
   ...
   <div id="scroll">
	...
	<div id="intro" class="tool" style=" -moz-background-clip: border; -moz-background-origin: padding; -moz-background-inline-policy: continuous;">
     ...
     <br/> <br/>
    <p align="left" style="font-size:16px;" onClick="ambildata30('awal')"><img src="icon/rumah.jpg" id="tombol_dp" value="dp" align="left" style="width:50px; height:40px; padding-right:5px;" /> Perumahan</p>
