...
#t6.active	{ background-position:-875px 0 !important; }
   ...
   <div id="scroll">
	...
	<div id="intro" class="tool" style=" -moz-background-clip: border; -moz-background-origin: padding; -moz-background-inline-policy: continuous;">
     ...
     <br/> <br/><br/><br/>
    <a href="view_perum1a.php?id=<?php echo $id;?>"> <p align="left" style="font-size:16px;"><img src="icon/transportasi.png" align="left" style="width:40px; height:30px; padding-right:5px;" /> Transportasi</p> </a>
	<br/><br/>
	<a href="view_perum1b.php?id=<?php echo $id;?>"> <p align="left" style="font-size:16px;"><img src="icon/layanan_umum.png" id="tombol_dp" value="dp" align="left" style="width:40px; height:30px; padding-right:5px;" onClick="ambildatadp('awal')"/> Layanan Umum</p></a>
	<br/><br/>
    <a href="view_perum1c.php?id=<?php echo $id;?>"> <p align="left" style="font-size:16px;"><img src="icon/pasar.png" id="tombol_dp" value="dp" align="left" style="width:40px; height:30px; padding-right:5px;" onClick="ambildatadp('awal')"/> Pasar</p></a>
	<br/><br/>
	<a href="view_perum1d.php?id=<?php echo $id;?>"> <p align="left" style="font-size:16px;"><img src="icon/pendidikan.jpg" id="tombol_dp" value="dp" align="left" style="width:40px; height:30px; padding-right:5px;" onClick="ambildatadp('awal')"/> Pendidikan</p></a>
	<br/><br/>
	<a href="view_perum1e.php?id=<?php echo $id;?>"> <p align="left" style="font-size:16px;"><img src="icon/wisata.png" id="tombol_dp" value="dp" align="left" style="width:40px; height:30px; padding-right:5px;" onClick="ambildatadp('awal')"/> Wisata</p></a>
	<br/><br/>
    <a href="view_perum1f.php?id=<?php echo $id;?>"> <p align="left" style="font-size:16px;"><img src="icon/rumah2.jpg" id="tombol_dp" value="dp" align="left" style="width:40px; height:30px; padding-right:5px;" onClick="ambildatadp('awal')"/> Perumahan Penduduk</p></a>
	<br/><br/>
    <table width="100%" border="0" cellspacing="0" cellpadding="5">
      <tr>
        <td><a href="http://www.lampung-datasource.url.ph/id/index.html"><p align="right">Back Home</p></a></td>
      </tr>
    </table>
	<script>
...
$("#t0").click(function() {
	...
	$("#scroll").scrollable().begin();
          ...
          <blockquote>
            <p>Silakan Klik Menu Navigasi Di Samping Untuk Mengakses Tampilan Peta Berdasarkan Pencarian Kategori <a href="view_perumx.php"><em> Cari </em></a></p>
            <?php //include "view_list.php";?>
			<p>
