...
#t6.active	{ background-position:-875px 0 !important; }
   ...
   <div id="scroll">
	...
	<div id="intro" class="tool" style=" -moz-background-clip: border; -moz-background-origin: padding; -moz-background-inline-policy: continuous;">
     ...
     <br/> <br/>
    <p align="left" style="font-size:16px;" onClick="ambildata15('awal')"><img src="icon/pemerintahan.jpg" id="tombol_dp" value="dp" align="left" style="width:40px; height:30px; padding-right:5px;"/> Pasar Tradisional</p>
	<br/>
	<p align="left" style="font-size:16px;" onClick="ambildata16('awal')"><img src="icon/polisi.jpg" id="tombol_dp" value="dp" align="left" style="width:40px; height:30px; padding-right:5px;"/> Minimarket</p>
	<br/>
	<p align="left" style="font-size:16px;" onClick="ambildata17('awal')"><img src="icon/supermarket.jpg" id="tombol_dp" value="dp" align="left" style="width:40px; height:30px; padding-right:5px;" /> Supermarket</p>
